namespace Hidistro.ControlPanel.Store
{
    ...
    public static class ManagerHelper
    {
        ...
        public static IList<RoleQx> GetRoleQx(int roleid)
        {
            return new RoleDao().GetRoleQx(roleid);
        }

        public static void SaveRoleQx(int roleid,string qx)
        {
            new RoleDao().SaveRoleQx(roleid,qx);
        }

        public static string GetModuleQx(int roleid) {
            return new RoleDao().GetModuleQx(roleid);
        }
        ...
        public static void ImportMenu(string file) {
            new MenuDao().ImportMenu(file);
            
        }

        public static IList<MenuQxInfo> GetMenuList(int roleid, string module)
        {
            return new MenuDao().GetList(roleid, module);
        }
    }
}
