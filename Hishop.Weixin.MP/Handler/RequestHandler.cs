...
namespace Hishop.Weixin.MP.Handler
{
	public abstract class RequestHandler
	{
        ...
        //返回的xml
        public string StringResonseMessage { get; set; }
		...
		private void Init(XDocument requestDocument)
		{
            ...
            //Utils.LogWriter.SaveLog("RequestMessage：" + RequestMessage.MsgType);

		}
		public void Execute()
		{
            //Utils.LogWriter.SaveLog("Execute：" + this.RequestMessage.MsgType);
			...
			if (this.RequestMessage != null)
			{
				...
				case RequestMsgType.Event:
					...
					break;
				default:
                    Utils.LogWriter.SaveLog("未知的MsgType请求类型：" + this.RequestMessage.MsgType);
		...
		{
            //Utils.LogWriter.SaveLog("eventRequest.Event:" + eventRequest.Event);
