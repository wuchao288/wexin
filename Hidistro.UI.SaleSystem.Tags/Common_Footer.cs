namespace Hidistro.UI.SaleSystem.Tags
{
    ...
    public class Common_Footer : VshopTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            this.litDistrbutorTitle.Text = "我要开店";
            ...
            if (currentMember != null)
            {
                ...
                {
                    this.litDistrbutorTitle.Text = "我是卖家";
            ...
            //判断金额&& (expenditure >= masterSettings.FinishedOrderMoney)
            this.paneldistributor.Visible = (masterSettings.IsRequestDistributor ) || ((info4 != null) && (info4.UserId > 0));
            ...
            if (info3 == null)
            {
                ...
                this.litDistrbutorUrl.Text = "DistributorError.aspx";
            }

            if (expenditure < masterSettings.FinishedOrderMoney)
            {
                this.litDistrbutorUrl.Text = "DistributorError.aspx";
            }
        }
