namespace Hidistro.Entities.Promotions
{
    ...
    public class CouponInfo
    {
        ...
        [RangeValidator(typeof(decimal), "0.01", RangeBoundaryType.Inclusive, "10000000", RangeBoundaryType.Inclusive, Ruleset="ValCoupon"), ValidatorComposition(CompositionType.Or, Ruleset="ValCoupon", MessageTemplate="满足金额，金额大小0.01-1000万之间"), NotNullValidator(Negated=true, Ruleset="ValCoupon")]
