namespace Hidistro.Entities.Sales
{
    ...
    public class ShippersInfo
    {
        ...
        [RegexValidator(@"[\u4e00-\u9fa5a-zA-Z]+[\u4e00-\u9fa5_a-zA-Z0-9]*", Ruleset="Valshipper", MessageTemplate="发货人姓名只能是汉字或字母开头"), StringLengthValidator(2, 20, Ruleset="Valshipper", MessageTemplate="发货人姓名不能为空，长度在2-20个字符之间"), HtmlCoding]
