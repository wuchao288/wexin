namespace Hidistro.Entities.Sales
{
    ...
    public class ShippingModeInfo
    {
        ...
        [NotNullValidator(Negated=true, Ruleset="ValShippingModeInfo"), ValidatorComposition(CompositionType.Or, Ruleset="ValShippingModeInfo", MessageTemplate="默认加价必须限制在1000万以内"), RangeValidator(typeof(decimal), "0.00", RangeBoundaryType.Inclusive, "10000000", RangeBoundaryType.Inclusive, Ruleset="ValShippingModeInfo")]
        public decimal? AddPrice { get; set; }

        [NotNullValidator(Negated=true, Ruleset="ValShippingModeInfo"), RangeValidator(0, RangeBoundaryType.Inclusive, 0x186a0, RangeBoundaryType.Inclusive, Ruleset="ValShippingModeInfo"), ValidatorComposition(CompositionType.Or, Ruleset="ValShippingModeInfo", MessageTemplate="加价重量必须限制在100千克以内")]
