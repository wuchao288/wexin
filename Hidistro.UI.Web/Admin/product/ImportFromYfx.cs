    ...
    public class ImportFromYfx : AdminPage
    {
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            if (this.CheckItems())
            {
                ...
                ProductHelper.ImportProducts((DataSet) importer.ParseProductData(new object[] { mappingSet, path, includeCostPrice, includeStock, includeImages })[0], categoryId, 0, bandId, delete, includeCostPrice, includeStock, includeImages);
