...
<ul>
            ...
            <li><span class="formitemtitle Pw_140">发送内容：</span>
              <asp:TextBox ID="txtTestSubject" runat="server" CssClass="forminput" Text="商城短信发送测试." ReadOnly="true"></asp:TextBox>
            </li>
            <li class="clear"></li>
          </ul>
          <ul class="btntf Pa_140">
             <asp:Button ID="btnTestSend" runat="server" OnClientClick="return TestCheck();" Text="发送" CssClass="submit_DAqueding inbnt">
          </asp:Button>
      </ul>
</div>
        </div>
