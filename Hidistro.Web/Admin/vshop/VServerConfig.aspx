	    ...
	    <div class="formitem validator1">
          ...
          <abbr class="formselect">
            ...
            <li class="clearfix" style="display:none"><span class="formitemtitle Pw_198">微信通用登录接口：</span>
             ...
             <li><h2 class="colorE">商城名称配置</h2></li>
              <li class="clearfix"><span class="formitemtitle Pw_198">LOGO：</span>
                <img src="/Utility/pics/headLogo.jpg?t=<%=DateTime.Now.ToFileTime() %>"/>
                  <p><asp:FileUpload ID="logoFile" runat="server" /></p>
                <p id="P2" runat="server">logo大小为 80 * 80 JPG</p>
            </li>
            ...
            <li><h2 class="colorE">多客服设置</h2></li>
            <li class="clearfix">
           ...
           <li style="display:none"><h2 class="colorE">系统接口设置</h2></li>
