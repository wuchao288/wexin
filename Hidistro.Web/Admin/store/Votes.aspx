    ...
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr class="table_title">
                      ...
                      <th width="19%" class=" td_right td_left">投票标题 </td>
                      <th width="10%" class=" td_right td_left">开始日期 </td>
                      <th width="10%" class=" td_right td_left">结束日期 </td>
                      <th width="8%" class=" td_right td_left">最多可选项数 </td>
                      <th width="6%" class=" td_right td_left">投票总数 </td>
                      <th width="6%" class=" td_right td_left">是否开启</td>
                      <th width="5%" class=" td_right td_left">关键字 </td>
                      <th width="6%" class=" td_left td_right_fff">操作 </td>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
              <tr>
