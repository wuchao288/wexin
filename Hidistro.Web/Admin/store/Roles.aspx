        ...
        <div class="datalist">
            ...
            <UI:Grid ID="grdGroupList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="RoleId" GridLines="None" HeaderStyle-CssClass="table_title" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="职能说明" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <div style="word-break: break-all;">
                                <asp:Literal ID="lblRoleDesc" Text='<%#Eval("Description") %>' runat="server"></asp:Literal></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="操作" ItemStyle-Width="15%" HeaderStyle-CssClass="td_left td_right_fff">
                        <ItemTemplate>
                            ...
                            <span class="submit_shanchu">
                                <Hi:ImageLinkButton runat="server" IsShow="true" ID="DeleteImageLinkButton1" CommandName="Delete" Text="删除" /></span>
                            
                            <a target="_self" id="role_<%# Eval("RoleId")%>" href="RolesQx.aspx?role_id=<%# Eval("RoleId")%>">权限</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>
    ...
    <div id="EditRole" style="display: none;">
        <div class="frame-content">
            ...
            <p><span class="frame-span frame-input90">职能说明：</span>
                <asp:TextBox ID="txtEditRoleDesc" runat="server" CssClass="forminput"></asp:TextBox></p>
