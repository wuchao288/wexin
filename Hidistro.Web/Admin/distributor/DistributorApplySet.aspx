            ...
            <div class="formitem validator2">
                <ul>
                    <li><span class="formitemtitle Pw_110">分销商注册入口：</span>
                        <span class="formitemtitle Pw_110">
                            <input id="radiorequeston" type="radio" name="radiorequest" runat="server" value="1" />开启
                        <input id="radiorequestoff" type="radio" name="radiorequest" runat="server" value="2" />关闭</span><span style="font-size: 14px;">（管理员可在分销商列表批量生成分销商账号)</span>
                    </li>
                    <li style="display: none" id="li_requestmoney">
                        <span class="formitemtitle Pw_110">分销商申请条件：</span>
                        <span class="formitemtitle Pw_130">消费金额达到：</span>
                        <span class="formitemtitle ">
                            <input type="text" id="txtrequestmoney" class="forminput" style="width: 60px" runat="server" />
                            <span style="display:inline"> 元 或 充值金额达到：</span>
                            <input type="text" id="txtRechargeMoney" class="forminput" style="width: 60px" runat="server" /> 元,必需是整数
                        </span>
                    </li>
                    ...
                    <li><span class="formitemtitle Pw_110">分销商提现设置：</span>
                        ...
                        <p id="ctl00_contentHolder_txtApplySetTip" style="padding-left: 20px;">
                            限制分销商填写提现金额必须该数值的倍数，不能为空，必须是整数
                        </p>
                    </li>
                    <li><span class="formitemtitle Pw_110">分销商招募细则：</span>
                        <abbr class="formselect">
                            <Kindeditor:KindeditorControl ID="ApplicationDescription" runat="server" Width="630px" Height="400px" />
                        </abbr>
                        <p style="padding-left: 20px;">
                            用户在申请分销商前需要阅读的分销商招募细则。
                        </p>
                    </li>
                    <li><span class="formitemtitle Pw_110">分销商攻略设置：</span>
                        <abbr class="formselect">
                            <Kindeditor:KindeditorControl ID="fkContent" ImportLib="false" runat="server" Width="630px" Height="400px" />
                        </abbr>
                        <p style="padding-left: 20px;">
                            用户在申请成为分销商时需阅读的分销攻略。
                        </p>
                ...
                <ul class="btn Pa_100 clearfix">
                    <asp:Button ID="btnSave" runat="server" OnClientClick="return PageIsValid();" OnClick="btnSave_Click" Text="保存"
