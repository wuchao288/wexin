          ...
          <div class="formitem validator2">
            <ul>
              ...
              <li> <span class="formitemtitle Pw_100">货号前缀：</span>
               ...
               <li><h2 class="colorE">分销商佣金设置</h2></li>
               <li> <span class="formitemtitle Pw_198"><em >*</em>直接销售分佣：</span>
                <asp:TextBox ID="txtfirst" runat="server" CssClass="forminput" />
                <p  id="ctl00_contentHolder_txtfirstTip"  >输入1~100的整数</p>
              </li>
               <li> <span class="formitemtitle Pw_198"><em >*</em>抽成二级分销商销售分佣：</span>
                <asp:TextBox ID="txtsecond" runat="server" CssClass="forminput" />
                <p class="Pa_198" id="ctl00_contentHolder_txtseoncdtooneTip"  >输入1~100的整数</p>
              </li>
              <li> <span class="formitemtitle Pw_198"><em >*</em>抽成三级分销商销售分佣：</span>
                <asp:TextBox ID="txtthird" runat="server" CssClass="forminput" />
                <p id="ctl00_contentHolder_txtthirdtooneTip"  >输入1~100的整数</p>
              </li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function InitValidators()
        {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtseoncdtoone', 1, 10, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，只能输入实数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtseoncdtoone', 0, 100, '输入的数值超出了系统表示范围'));
            initValid(new InputValidator('ctl00_contentHolder_txtthirdtoone', 1, 10, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，只能输入实数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtthirdtoone', 0, 100, '输入的数值超出了系统表示范围'));
            initValid(new InputValidator('ctl00_contentHolder_txtsecondtothree', 1, 10, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，只能输入实数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtsecondtothree', 0, 100, '输入的数值超出了系统表示范围'));
