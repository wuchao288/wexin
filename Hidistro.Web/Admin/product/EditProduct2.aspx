<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProduct2.aspx.cs" Inherits="Hidistro.Web.Admin.product.EditProduct2" %>
            ...
            <div class="formitem validator1">
	            ...
	            <p id="ctl00_contentHolder_txtCostPriceTip">商品的成本价</p>
                    ...
                    <li><span class="formitemtitle Pw_198">商品图片：</span>
                        ...
                        <p class="Pa_198 clearfix" m_none>建议上传尺寸为：650px*650px，格式为：.jpg、.png的图片文件</p>
                    </li>
