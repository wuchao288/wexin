        ...
        <div class="columnright">
            ...
            <div class="formitem validator4">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_110"><em>*</em>充值金额：</span>
                        <asp:TextBox ID="txtRecharge" CssClass="forminput" runat="server" />
                        <p id="P1">设置会员充值达到多少元以后自动升级到此等级，为大于等于0的整数</p>
                    </li>
                        ...
                        <span>
                            <table width="400" border="0" cellspacing="0">
                                <tr>
                                    <td width="70">一口价  ×</td>
                                    <td width="39">
                                        <asp:TextBox ID="txtValue" CssClass="forminput" Width="90px" runat="server" /></td>
