...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
    <script src="/admin/js/member/member_list.js" type="text/javascript"></script>
		  ...
		  <div class="batchHandleArea">
		    ...
		    <UI:Grid ID="grdMemberList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="UserId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="会员ID"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        ...
                        <asp:TemplateField HeaderText="姓名"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                      ...
                      <asp:TemplateField HeaderText="手机号"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        ...
                        <asp:TemplateField HeaderText="QQ"  ItemStyle-Width="100px" SortExpression="Balance" HeaderStyle-CssClass="td_right td_left" >                            
                            <itemtemplate>
                                &nbsp;<%# Eval("QQ") %>
                            </itemtemplate>
                        </asp:TemplateField> 

                        <asp:TemplateField HeaderText="推荐人"  ItemStyle-Width="100px" SortExpression="Balance" HeaderStyle-CssClass="td_right td_left" >                            
                            <itemtemplate>
                                &nbsp;<%# Eval("ReferralUserName") %>
                            </itemtemplate>
                        </asp:TemplateField> 
                        <asp:TemplateField HeaderText="邮箱"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        <ItemTemplate><span class="email"><%# Eval("Email")%></span></ItemTemplate>
                        </asp:TemplateField>                       
                      <%--  <asp:TemplateField HeaderText="会员卡号"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        ...
                        <asp:TemplateField HeaderText="分销商" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate >
                                <span class="isopen" isopen="<%# Eval("IsOpen") %>">
                                  
                                </span>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="累计充值" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate >
                                <%# Eval("account") %>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="可用余额" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate >
                                <%# Eval("amount") %>
                            </ItemTemplate>
                        </asp:TemplateField>
...
<script type="text/javascript" language="javascript">
    ...
    function SendMessage() {
        ...
        $(".datalist input[type='checkbox']:checked").each(function (rowIndex, rowItem) {
            ...
            var cellphone = $.trim($(this).parent("td").parent("tr").find("td:eq(3)").text().replace(/\s/g, "").replace("　", ""));
    ...
    function SendEmail() {
        ...
        $(".datalist input[type='checkbox']:checked").each(function (rowIndex, rowItem) {
            var realname = $(this).parent("td").parent("tr").find("td:eq(1) span:eq(0)").text().replace(/\s/g, "");
            var email = $.trim($(this).parent().parent().find(".email").text().replace(/\s/g, "").replace("　", ""));
            email = email.replace(" ", "");
