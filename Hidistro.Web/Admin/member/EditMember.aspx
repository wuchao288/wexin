...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator4 clearfix">
        <ul>
          ...
          <li style="display:none;"> <span class="formitemtitle Pw_110"><em >*</em>电子邮件地址：</span>
          ...
          <li> <span class="formitemtitle Pw_110">手机号码：</span>
            ...
            <li> <span class="formitemtitle Pw_110">推荐人ID：</span>
            <asp:TextBox ID="txtReferralUserId" runat="server" CssClass="forminput"></asp:TextBox>
            <p  id="P1">只能输入数字</p>
          </li>
