  ...
  <div class="datalist">
    <UI:Grid ID="grdMemberRankList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="GradeId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="积分满足点" ItemStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                           <asp:Literal ID="litPoints" Text='<%#Eval("Points") %>' runat="server"></asp:Literal>
                        </ItemTemplate>
                  </asp:TemplateField>

                  <asp:TemplateField HeaderText="充值金额" ItemStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                           <%#Eval("recharge") %>
                        </ItemTemplate>
                  </asp:TemplateField>
