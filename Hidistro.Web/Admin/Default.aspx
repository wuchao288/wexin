...
<div class="hishop_list">
    <ul>
         <li><a href="javascript:ShowSecondMenuLeft('微商品','member/AddMemberGrade.aspx',null)"><img src="images/1.png" /><br />s</a></li>
...
<div class="hishop_list_content">
    <div class="hishop_list_l">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="td_cont_left">当前版本</td><td class="sp_img">V1.0.1</td>
            </tr>
            <tr>
            </tr>
        </table>
    ...
    <div class="hishop_list_r">
             <div class="hishop_contenttitle">速特销动态</div>
